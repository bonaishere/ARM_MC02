...
*******************************************************************************/
uint8 Input_GetNumOfPresses(Service_DeviceChannel MasterDeviceChannel, Service_DeviceChannel MasterStatusChannel, Service_DeviceChannel SlaveDeviceChannel, Service_DeviceChannel SlaveStatusChannel, Button_AttachType ButtonAttach)
{
